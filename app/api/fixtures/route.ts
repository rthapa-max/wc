...
const FIXTURE_COLUMNS =
  "id,date_label,time,home,away,stage,group,stadium,city,status,kickoff_at,result_home_score,result_away_score,result_et_home_score,result_et_away_score,result_penalty_winner,result_penalty_home_score,result_penalty_away_score,knockout_scoring_version,result_status";
