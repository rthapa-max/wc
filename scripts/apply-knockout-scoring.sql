-- One-shot migration: knockout ET/penalty scoring. Group stage (First Stage) stays 3/2/1.
...
-- 2) Align legacy winner column with stored scores (0-0 safe)
